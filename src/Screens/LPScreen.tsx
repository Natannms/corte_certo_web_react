                ...
                <header className="bg-black text-white">
                    <div className="container mx-auto flex justify-between items-center py-6 px-4 lg:px-8">
                       ...
                       <div className="flex gap-1">
                        <button onClick={() => navigate("/register")} className="bg-yellow-500 text-black font-semibold py-2 px-4 rounded-lg hover:bg-yellow-600">
                                Cadastre-se
                            </button>
                            <button onClick={() => navigate("/login")} className="bg-green-500 text-black font-semibold py-2 px-4 rounded-lg hover:bg-green-600">
                                Entrar
                            </button>
                       </div>
                    </div>
                ...
                <section className="bg-black text-white pt-12 px-4 lg:px-8">
                    <div className="container mx-auto flex flex-col md:flex-row items-center">
                        <div className="md:w-1/2 space-y-6">
                            <h1 className="text-5xl font-extrabold leading-tight">Soluções para barbearias</h1>
                            <p className="text-lg text-gray-400">
                                Chegou a solução definitiva para otimizar sua barbearia! Controle de produtos, serviços, estoque, agendamentos e mais, tudo em um único lugar. Potencialize seu crescimento e ganhe tempo para o que realmente importa: seus clientes.
                            </p>
                            <button className="bg-yellow-500 text-black font-semibold py-3 px-6 rounded-lg hover:bg-yellow-600" onClick={() => navigate("/register")}>Comece gratuitamente</button>
                        </div>
